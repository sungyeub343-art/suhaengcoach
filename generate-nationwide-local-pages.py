...
def build_city_page(province_name, short_name, group, area_name, area_slug, items):
    ...
    return (
        ...
        f'<title>{area_name} 스마트무인자판기 설치 안내 | 수행코치</title>'
        ...
        '<span>수행코치 <small>VENDING STUDIO</small></span></a><nav class="main-nav">'
...
def build_detail_page(province_name, short_name, group, area_name, area_slug, item):
    ...
    return (
        ...
        f'<title>{full_area} 스마트무인자판기 설치 안내 | 수행코치</title>'
...
def write_legacy_redirects():
    ...
    legacy_path.write_text(
        ...
        '<title>대구 군위군 설치 안내로 이동 | 수행코치</title></head><body>'
