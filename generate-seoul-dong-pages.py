...
def update_district_page(districts):
    ...
    script = (
        ...
        'document.title=area+" 스마트무인자판기 설치 안내 | 더세이브 수행코치";'
